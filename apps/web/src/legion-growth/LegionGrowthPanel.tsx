import type {
  LegionGrowthSnapshot,
  LegionGrowthUnitSnapshot,
...
function growthMetrics(unit: LegionGrowthUnitSnapshot): readonly GrowthMetric[] {
  return [
    ...
    {
      label: '正面防禦',
      before: unit.before.frontalDefense,
      after: unit.after.frontalDefense,
    },
    ...
    >
      ...
      <div className="growth-card-grid">
        {snapshot.units.map((unit) => {
          ...
          return (
            <article
              className="growth-unit-card"
              aria-labelledby={titleId}
              data-testid="growth-unit-card"
              key={unit.after.id}
            >
